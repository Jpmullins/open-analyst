            ...
            <div className="text-sm text-text-muted space-y-1 ml-6">
              ...
              {showTools && serverTools.length > 0 && (
                <div className="mt-3 ml-6 p-3 rounded-lg bg-surface-muted border border-border">
                  <div className="text-xs font-medium text-text-primary mb-2">{serverTools.length} available tools:</div>
        ...
        <>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-sm font-medium text-text-primary">Environment Variables</label>
              <button
                type="button"
                onClick={addEnvVar}
